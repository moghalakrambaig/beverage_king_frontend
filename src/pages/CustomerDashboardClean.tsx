...
export default function CustomerDashboard() {
  ...
  useEffect(() => {
    async function load() {
      if (!id) return;
      try {
        const res = await api.getCustomerById(id); // returns { message, data }
        const data = res.data;
  ...
  if (!customer)
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <p className="p-8 text-center text-muted-foreground font-semibold">
          Loading...
        </p>
      </div>
    );
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-6">
            <div className="rounded-2xl bg-card border border-border p-6 shadow-sm">
              ...
              <p className="text-5xl font-bold mb-2 text-foreground">
          ...
          <div className="max-w-5xl mx-auto mt-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <a
                ...
                className="p-6 rounded-xl bg-card border border-border hover:border-primary transition-all flex flex-col items-center"
              >
                <Crown className="w-10 h-10 text-primary mb-3" />
                <h3 className="font-semibold">Single Barrels</h3>
                <p className="text-sm text-muted-foreground text-center mt-2">
                  Unique expressions from single casks — limited and special.
                </p>
              </a>
              ...
              >
                ...
                <p className="text-sm text-muted-foreground text-center mt-2">
                  See what's new on the shelf and get notified of releases.
                </p>
              </a>
              ...
              >
                ...
                <p className="text-sm text-muted-foreground text-center mt-2">
                  Join tastings, events and meet the experts behind the pour.
                </p>
              </a>
            </div>
          </div>
